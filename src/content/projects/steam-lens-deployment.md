...
forced-command — it can trigger the box's deploy script and do nothing else. The job ships
the exact reviewed build by digest, the script refuses to deploy while a visitor's analysis
